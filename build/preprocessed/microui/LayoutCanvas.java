 ...
 * @author h
 */
public class LayoutCanvas extends MicroCanvas {

    public static final int FLOW_LEFT   = 1;
    public static final int FLOW_RIGHT  = 2;
    public static final int FLOW_NEXT   = 3;
    ...
    public LayoutCanvas(Vector items) {
        this.items = items;
    ...
    public GenericItem getItem(int index) {
        return (GenericItem) items.elementAt(index);
    }

    public void addItem(GenericItem item, int position) {
        items.addElement(item);
        layout.addElement(new Integer(position));
    }
