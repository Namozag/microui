 ...
 * @author h
 */
public class ExtendedMenu extends Canvas {
    ...
    boolean SELECT_ON_POINT     = false;
    boolean MARK_ON_FIRE      = false;
    boolean ACTION_ON_FIRE      = false;
    boolean OPEN_EMPTY_ITEMS    = true;
    boolean STICK_ON_SELECT     = false;
    boolean ENABLE_INFO         = true;

    public ExtendedMenu(NavigatableMenu menu) {
        this.menu = menu;
