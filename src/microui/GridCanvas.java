...
public class GridCanvas extends Canvas {
    ...
    public GridCanvas(GenericItem[] items, int itemWidth, int itemHeight) {
        ...
        int im = itemWidth / 10;
        int c = screenWidth / itemWidth;
        int m = (screenWidth - c * itemWidth) / (c + 1);

        if (m < im) {
            c--;
            m = (screenWidth - c * itemWidth) / (c + 1);
        }
